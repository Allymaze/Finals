    ...
    public partial class fillUpForm : Form
    {
         ...
         void generateCode()
        {
             ...
             if (txtIDno.Text == "" || txtName.Text == "" || txtMI.Text == "" || txtLastName.Text == "")
             {
                 ...
                 try
                 {
                     ...
                     if (radioButton1.Checked == true)
                     {
                         ...
                         string sql = "insert into tbl_Student(ID,Name,MI,Lname,completeName,HAddress,DateBirth,Age,TellNum,Gender,Guardian,PAddress,Contact,Dates,studentStand,levelType,course) values('" + txtIDno.Text + "','" + txtName.Text + "','" + txtMI.Text + "','" + txtLastName.Text + "','" + txtName.Text + " " + txtMI.Text + " " + txtLastName.Text +
                                    "','" + txtHomeAddress.Text + "','" + dateTimePicker1.Text + "','" + txtAge.Text + "','" + txtTelephone.Text + "','" + cmbGender.Text + "','" + txtGuard.Text + "','" + txtAddress.Text + "','" + txtContact.Text + "','" + DateTime.Now.ToString() + "','" + radioButton1.Text + "','" + cmbLvlType.Text + "','" + txtcourse.Text + "')";
                         cm = new SqlCommand(sql, cn);
                         cm.ExecuteNonQuery();
                     ...
                     if (radioButton2.Checked == true)
                     {
                         ...
                         string sql = "insert into tbl_Student(ID,Name,MI,Lname,completeName,HAddress,DateBirth,Age,TellNum,Gender,Guardian,PAddress,Contact,Dates,studentStand,levelType,course) values('" + txtIDno.Text + "','" + txtName.Text + "','" + txtMI.Text + "','" + txtLastName.Text + "','" + txtName.Text + " " + txtMI.Text + " " + txtLastName.Text +
                                    "','" + txtHomeAddress.Text + "','" + dateTimePicker1.Text + "','" + txtAge.Text + "','" + txtTelephone.Text + "','" + cmbGender.Text + "','" + txtGuard.Text + "','" + txtAddress.Text + "','" + txtContact.Text + "','" + DateTime.Now.ToString() + "','" + radioButton2.Text + "','" + cmbLvlType.Text + "','" + txtcourse.Text + "')";
                         cm = new SqlCommand(sql, cn);
                         cm.ExecuteNonQuery();
                         MessageBox.Show("Record Successfully Saved!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
         ...
         private void studentList_SelectedIndexChanged(object sender, EventArgs e)
         {
             ...
             cmbLvlType.Text = studentList.FocusedItem.SubItems[15].Text;
             txtcourse.Text = studentList.FocusedItem.SubItems[19].Text;
         }
         ...
         private void txtSearch_TextChanged(object sender, EventArgs e)
         {
             try
             {
                 ...
                 studentList.Columns.Add("Year level", 200);
                 studentList.Columns.Add("Course", 200);
                 ...
                 while (dr.Read())
                 {
                     ...
                     list.SubItems.Add(dr.GetValue(19).ToString());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "Update tbl_Student set Name = '" + txtName.Text + "',MI = '" + txtMI.Text + "',Lname = '" + txtLastName.Text + "',completeName = '" + txtName.Text + " " + txtMI.Text + " " + txtLastName.Text + "',HAddress = '" + txtHomeAddress.Text + "',DateBirth = '" + dateTimePicker1.Text + "',Age = '" + txtAge.Text
                                                                   + "',TellNum = '" + txtTelephone.Text + "',Gender = '" + cmbGender.Text + "',Guardian = '" + txtGuard.Text + "',PAddress = '" + txtAddress.Text + "',Contact = '" + txtContact.Text + "',levelType = '" + cmbLvlType.Text + "',course = '" + txtcourse.Text + "' where ID like '" + txtIDno.Text + "' ";
