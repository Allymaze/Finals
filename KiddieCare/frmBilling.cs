...
namespace KiddieCare
{
    public partial class frmBilling : Form
    {
        ...
        private void cmbModePay_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbModePay.SelectedItem == "Full Payment")
            {
                getTotTuition();
                getMode();
        ...
        private void txtID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr.HasRows /*&& bal != "0"*/)
                {
                    MessageBox.Show("You have a previous balance", "EnrollMe", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Insuficient amount to pay downpayment", "EnrollMe", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            if (txtID.Text == "")
            {
                MessageBox.Show("Please input the empty fields", "EnrollMe", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
               // try
               ...
               // catch (Exception ee)
              //  {
               //     MessageBox.Show(ee.Message, "EnrollMe", MessageBoxButtons.OK, MessageBoxIcon.Warning);
               // }
            }
