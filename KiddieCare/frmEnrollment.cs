...
namespace KiddieCare
{
    public partial class frmEnrollment : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (txtBillID.Text == "")
            {
                MessageBox.Show("Please search student to be enroll", "EnrollMe", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
                try
                {
                    ...
                    MessageBox.Show("Mr/Ms " + lblName.Text + " is successfully enrolled", "EnrollMe", MessageBoxButtons.OK, MessageBoxIcon.Information);
