...
namespace KiddieCare
{
    public partial class frmMain : Form
    {
        ...
        internal object toolBilling;

        public object btnBilling { get; internal set; }
        ...
        {
        //    DialogResult dialogResult = MessageBox.Show("Are you sure you want to logout this account?", "EnrollMe", MessageBoxButtons.YesNo);
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Are you sure you want to sign out?", "EnrollMe", MessageBoxButtons.YesNo);
            if (dialogResult == DialogResult.Yes)
            {
                string sql = "update tbl_user set status = 'offline' where uID like '" + uID + "'";
                cm = new SqlCommand(sql, cn);
