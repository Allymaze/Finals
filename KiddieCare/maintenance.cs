...
namespace KiddieCare
{
    public partial class maintenance : Form
    {
        ...
        void ListGradeLvl()
        {
            listGradeLvl.Columns.Add("Year Level", 500);
        ...
        private void btnDelGradeLvl_Click(object sender, EventArgs e)
        {
            string sql = "delete from tbl_gradeLvl where Room like '" + txtGradeLvl.Text + "'";
            cm = new SqlCommand(sql, cn);
            cm.ExecuteNonQuery();
            MessageBox.Show("Successfuly Delete!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listGradeLvl.Items.Clear();
