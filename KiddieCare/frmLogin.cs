...
namespace KiddieCare
{
    public partial class frmLogin : Form
    {
        ...
        public string constring = @"Data Source=LAPTOP-QGM632H9\SQLEXPRESS01;Initial Catalog=kiddieCareDb;Integrated Security=True";
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("This account is currently online, you forgot to logout. Please approach administrator for help. Thank you", "EnrollMe", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dr.Close();
                    return;
                }
                dr.Close();
                ...
                if (dr.HasRows)
                {
                    if (dr[4].ToString() == "finance")
                    {
                        ...
                        main.btnFee.Enabled = true;
                        main.btnTime.Enabled = false;
                        main.toolDiscount.Enabled = true;
                        main.toolDownpay.Enabled = true;
                        main.studentEntryToolStripMenuItem.Enabled = false;
                        main.scheduleToolStripMenuItem.Enabled = false;
                        main.teacherEntryToolStripMenuItem.Enabled = false;
                    ...
                    {
                        main.accesscodeform = true;
                        main.btnAddSecurity.Enabled = true;
                        main.btnAddLvl.Enabled = true;
                        main.btnAddRoom.Enabled = true;
                        main.btnAddSection.Enabled = true;
                        main.btnAddSecurity.Enabled = true;
                        main.btnAddSubject.Enabled = true;
                        main.btnAddYear.Enabled = true;
                        main.btnFee.Enabled = false;
                        main.btnTime.Enabled = false;
                        main.toolDiscount.Enabled = false;
                        main.toolDownpay.Enabled = false;
                        main.billing.Enabled = false;
                        

                    }
                    MessageBox.Show("\tSuccessfully LogIn as " + dr.GetValue(3).ToString(), "EnrollMe", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    dr.Close();
                    getuID();
                    //insertToLogTrail();
                    updateStatus();
